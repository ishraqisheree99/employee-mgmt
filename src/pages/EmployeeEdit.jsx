  ...
  useEffect(() => {
    ...
    if (employeeToEdit) {
      setFormData({
        ...
        skills: employeeToEdit.skills ? employeeToEdit.skills.join(', ') : '',
        performance: employeeToEdit.performance || '',
      });
    } else {
      navigate('/employees');
    }
  ...
  return (
    <div className="mx-auto max-w-4xl space-y-6 animate-fade-in">
      <div>
        ...
        <p className="mt-2 text-sm text-gray-600">Update employee information</p>
      </div>
